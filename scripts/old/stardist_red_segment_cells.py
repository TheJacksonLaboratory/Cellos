...
IO1BC=image_2um_r15[l_coords[organID][0]:l_coords[organID][3],l_coords[organID][1]:l_coords[organID][4],:,0]

plt.figure(figsize=(5,5))
plt.imshow(IO1BC.max(axis=2), cmap ='gray')
plt.savefig(output_dir+file_name+'red_organoid{:d}.pdf'.format(organID))
...
plt.savefig(output_dir+file_name+'red_segment_cells{:d}.pdf'.format(organID))
...
df.to_csv(output_dir+file_name+'_red_cells{:d}.csv'.format(organID))
